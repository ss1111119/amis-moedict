...
GENERIC = {"東西","對象","地方","事情","物品","事物","情況","方法","行為",
           ...
           "時間","時候","地點","原因","部位","氣味","樣子","程度","狀態",
           "方面","形狀","用具","器具","處","東西們",
           # 字典元描述詞（非詞義，須過濾）
           "名稱","促使","人名","姓氏","短語","短詞",
           # 2026-06-27 fan-out>50 補：元描述/語法殼（見 fanout-over50.tsv）
           "使用","指所","物件","借詞","起來","日語","指被","指要","工具",
           "命令","出來","表示","特地","能夠","準備","做事","閩南語","手段",
           "進去","下來","做成","令人","有意","能力","指有","感到","放在",
           "器物","用來"}
